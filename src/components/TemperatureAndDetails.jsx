...
import { formatToLocalTime, iconUrlFromCode } from '../services/serviceWeather';
  ...
  return (
    <div>
        ...
        <div className="flex flex-row items-center justify-center space-x-2 text-white text-sm py-3">
            ...
            <p className="font-light">|</p>
            <UilSun />
            <p className="font-light">Hight:<span className="font-medium ml-1">{`${temp_max.toFixed()}°`}</span></p>
            <p className="font-light">|</p>
            <UilSun />
